...
public class Utils
{
    ...
    public static void createPdf(String customerName, String airlineName, String bookingDate, String departureAirport, String arrivalAirport, String flightDate, 
            String flightTime, String totalHours, String flightNo, String seatNo, String departureTerminal, String arrivalTerminal,
            String departureGateNo, String arrivalGateNo
            ) throws IOException
    {
...
//            document.add(new Paragraph(new Date(new java.util.Date().getTime()).toString()));
            ...
            PdfPTable flightDetailCustomer = new PdfPTable(2);
            flightDetailCustomer.setWidthPercentage(100);
            flightDetailCustomer.setWidths(new int[]{1, 1});
            flightDetailCustomer.addCell(createTextCellBold("Booking Date"));
            flightDetailCustomer.addCell(createTextCellBold("Name"));
            document.add(flightDetailCustomer);
            
            PdfPTable flightDetailCustomer1 = new PdfPTable(2);
            flightDetailCustomer1.setWidthPercentage(100);
            flightDetailCustomer1.setWidths(new int[]{1, 1});
            flightDetailCustomer1.addCell(createTextCell(bookingDate));
            flightDetailCustomer1.addCell(createTextCell(customerName));
            document.add(flightDetailCustomer1);

            Paragraph FlightDetails = new Paragraph("Flight Details", regular);
            FlightDetails.setSpacingBefore(18);
            ...
            flightDetailHeadline.addCell(createTextCellBold("To"));
            ...
            PdfPTable flightDetailHeadline6 = new PdfPTable(2);
            flightDetailHeadline6.setWidthPercentage(100);
            flightDetailHeadline6.setWidths(new int[]{1, 1});
            flightDetailHeadline6.addCell(createTextCellBold("Departure Gate No"));
            flightDetailHeadline6.addCell(createTextCellBold("Arrival Gate No"));
            document.add(flightDetailHeadline6);
            
            
            PdfPTable flightDetail6 = new PdfPTable(2);
            flightDetail6.setWidthPercentage(100);
            flightDetail6.setWidths(new int[]{1, 1});
            flightDetail6.addCell(createTextCell(departureGateNo));
            flightDetail6.addCell(createTextCell(arrivalGateNo));
            document.add(flightDetail6);
            ...
            flightDetailHeadline1.addCell(createTextCellBold("Airline"));
            flightDetailHeadline1.addCell(createTextCellBold("Flight No"));
            ...
            flightDetail1.addCell(createTextCell(airlineName));
            flightDetail1.addCell(createTextCell(flightNo));
            ...
            flightDetailHeadline2.addCell(createTextCellBold("Departure Date"));
            flightDetailHeadline2.addCell(createTextCellBold("Total hours"));
            ...
            flightDetail2.addCell(createTextCell(flightDate + "  " + flightTime));
            flightDetail2.addCell(createTextCell(totalHours));
...
//            document.add(new Paragraph(new Date(new java.util.Date().getTime()).toString()));
    ...
    public static void emailFoodOrder(String email, String text){
        // Mail Service
        try{
            Properties properties = new Properties();
            properties.put("mail.smtp.auth", "true");
