...
public class BookTicketPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(departureAirport == null || "".equals(departureAirport.trim()))
        {
            showMessageDialog(this, "Please select departure airport", "Error", ERROR_MESSAGE);
            return;
        }
        else if(arrivalAirport == null || "".equals(arrivalAirport.trim()))
        {
            showMessageDialog(this, "Please select arrival airport", "Error", ERROR_MESSAGE);
            return;
        }
        else if(txtDate.getDate() == null)
        {
            showMessageDialog(this, "Please select travel date", "Error", ERROR_MESSAGE);
            return;
        }
        ...
        for(Airplane airplane : ecoSystem.getAirplaneDirectory().getAirplanes())
        {
            if(airplane.getDepartureAirport().equals(departure) 
                    ...
                    && airplane.getDepartureTerminal() != null
                    && airplane.getArrivalTerminal() != null
                    )
            {
                result.add(airplane);
            }
        ...
        if(result.isEmpty())
        {
            showMessageDialog(this, "No flight found", "Error", ERROR_MESSAGE);
            return;
        }
