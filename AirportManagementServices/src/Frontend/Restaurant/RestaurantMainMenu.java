 ...
 * @author nemad
 */
public class RestaurantMainMenu extends javax.swing.JPanel {
    ...
    JFrame mainJFrame;
    public RestaurantMainMenu(JFrame mainJFrame, Restaurant restaurant,EcoSystem ecoSystem) {
        initComponents();
    ...
    private void btnAddMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddMenuActionPerformed
        AddMenuPanel addMenuPanel = new AddMenuPanel(mainJFrame, restaurant, ecoSystem);
    ...
    private void btnEditMenuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditMenuActionPerformed
        EditMenuPanel editMenuPanel = new EditMenuPanel(mainJFrame, restaurant, ecoSystem);
