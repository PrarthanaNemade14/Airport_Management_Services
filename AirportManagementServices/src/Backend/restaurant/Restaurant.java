...
//        this.deliveryMans = new ArrayList<>();
    ...
    public Restaurant(String name, String address, String city, String state, String postalCode, String userName, String managerName, List<Dish> menu, List<RestaurantOrder> orders) {
        this.name = name;
