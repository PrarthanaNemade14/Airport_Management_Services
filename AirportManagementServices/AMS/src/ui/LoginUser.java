...
//        System.out.println("ui.Airline.AddFlight.paintComponent()"+this.getWidth()+" "+this.getHeight());
    ...
    private void initComponents() {
        ...
        jLabel4.setText("AIRPORT MANAGEMENT SERVICES");
        add(jLabel4);
        jLabel4.setBounds(600, 20, 680, 130);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        else if(Role.hotelRole.equals(userRole)) {
            Hotel hotel = ecoSystem.getHotelDirectory().getHotelFromUsername(userName);
            HotelPanel hotelPanel = new HotelPanel(mainJFrame, hotel, ecoSystem);
            mainJFrame.setContentPane(hotelPanel);
            mainJFrame.revalidate();
            mainJFrame.repaint();
        }
